...
async def load_vectorstore(uploaded_files: List[UploadFile], uploaded: str, doc_id: str):
    ...
    Args:
        ...
        uploaded (str): username uploaded by
    ...
    # extract meta data, create id, store page content in a variable
